...
var apipath_base_photo_dm='http://e3.businesssolutionapps.com/royal/syncmobile3/dmpath?CID=RCL&HTTPPASS=e99business321cba'
//var apipath_base_photo_dm='http://127.0.0.1:8000/royal/syncmobile3/dmpath?CID=RCL&HTTPPASS=e99business321cba'
...
function getLocationInfo() { //location
	var options = { enableHighAccuracy: false,timeout:120000};//20sec
...
function getSheduledRetailer(){	
	...
	if (search_date=='' || search_date==undefined){		
		...
		if (serch_date=='Invalid Date'){		
			...
			//http://127.0.0.1:8000/royal/syncmobile/getScheduleClientList?cid=RCL&rep_id=1001&rep_pass=123&synccode=2568&sch_date=2014-9-14
...
function sheduledRetailerVisitNext() {
	...
	if(visit_client=='' || visit_client==0){
			...
			//alert(localStorage.base_url+'getClientInfo?cid='+localStorage.cid+'&rep_id='+localStorage.user_id+'&rep_pass='+localStorage.user_pass+'&synccode='+localStorage.synccode+'&client_id='+visitClientId);
   			//http://127.0.0.1:8000/royal/syncmobile/getClientInfo?cid=RCL&rep_id=1001&rep_pass=123&synccode=2568&client_id=R100008
...
/*function marketNext() {
	...
	if(market_name=='' || market_name==0){
			...
			//http://127.0.0.1:8000/royal/syncmobile/getMarketClientList?cid=RCL&rep_id=1001&rep_pass=123&synccode=7048&market_id=M000003
			// ajax-------
			$.ajax({
				 type: 'POST',
				 ...
				 success: function(result) {
						...
						if (result==''){					
							...
							if (resultArray[0]=='FAILED'){						
								...
								//--------------
								//client_photo_strimage.src = 'http://e.businesssolutionapps.com/royal/static/client_pic/'+client_photo_str;
